...
class DummyStockAvailabilityChecker : StockAvailabilityChecker {
    ...
    override fun checkAvailability(
        ...
        return runCatching {
            ...
            log.debug(
                "Stock check: sku={}, requested={}, available={}, sufficient={}",
                sku,
                quantity,
                availableStock,
                isAvailable,
    ...
    override fun reserve(
        ...
        return runCatching {
            ...
            if (currentStock >= quantity) {
                ...
                log.debug(
                    "Stock reserved: sku={}, quantity={}, remaining={}",
                    sku,
                    quantity,
                    stockLevels[sku],
                )
            } else {
                error("Insufficient stock for $sku: available=$currentStock, requested=$quantity")
            }
        }
    }
